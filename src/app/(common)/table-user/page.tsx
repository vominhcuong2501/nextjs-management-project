...
export default function TableUser() {
  const columns: ColumnsProps[] = [
    ...
    {
      title: <p className="text-18 md:text-20 text-gradient-oneibc">Name</p>,
      dataIndex: "name",
      key: "name",
      sortDirections: ["descend"],
      sorter: (item2, item1) => {
    ...
    {
      title: <p className="text-18 md:text-20 text-gradient-oneibc">Email</p>,
      dataIndex: "email",
      key: "email",
      sortDirections: ["descend"],
      sorter: (item2, item1) => {
    ...
    {
      title: (
        <p className="text-18 md:text-20 text-gradient-oneibc">Phone number</p>
      ),
