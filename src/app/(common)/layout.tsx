...
export default function AuthLayout({ children }: CommonLayoutProps) {
	return (
		<section
			className="flex gap-3 lg:gap-5 p-3 lg:p-5 min-h-screen bg-gradient-to-r from-[#7fe2f3] to-[#5f88c9] flex-col md:flex-row"
		...
		>
			<div className="flex items-center justify-between">
				...
				<div className="border border-neutral-1 rounded-lg ">
					<svg
						width="44"
						height="44"
						viewBox="0 0 44 44"
