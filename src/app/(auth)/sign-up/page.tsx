			...
			<div className="mt-2">
				<form className=" grid grid-cols-1 gap-3 lg:gap-4">
					...
					<Button
						...
						} bg-gradient-to-r from-green-400 via-cyan-400 to-indigo-400 lg:h-14 h-8 rounded-[50px] text-14 lg:text-16 font-semibold w-full leading-1-4 text-neutral-1 border-0 mt-4`}
					>
						Sign Up
					</Button>
				</form>
