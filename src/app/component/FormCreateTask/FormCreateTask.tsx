...
export default function FormCreateEditTask({ projectData }: FormCreateTaskProps) {
	...
	const dataFilterProjectId: any =
		projectData && projectData?.filter((item: ProjectItem) => item.id === selectProjectName)
	...
	return (
		<div className='w-screen lg:w-[50vw] h-screen shadow-primary bg-neutral-1 pt-8 md:px-4 overflow-y-scroll scrollbar-input'>
			<div className='relative'>
				<h2 className='text-24 lg:text-32 text-gradient-red font-bold leading-1-4 text-center'>Create Task</h2>
				<svg
			...
			<div className='rounded-lg bg-white bg-opacity-50 backdrop-blur-lg p-4 '>
				<form className='grid grid-cols-1 gap-5'>
					<div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
						<div>
							...
							<SelectController
								...
								iconSelect={<FileSearchOutlined className='text-20 text-blue-15  ' />}
							/>
						</div>
						...
						<div>
							...
							{isClient && (
								<Select
									...
									isMulti
									name='listUserAsign'
									options={dataAssignMemberOption && dataAssignMemberOption?.flat()}
					...
					<div>
						<label htmlFor='' className='text-14 lg:text-16 text-neutral-8 leading-1-4 font-semibold '>
