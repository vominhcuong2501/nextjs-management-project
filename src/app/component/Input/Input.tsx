...
export default function Input({
	...
	register,
	rules,
	classNameInput = "w-full md:h-12 h-11 rounded-[20px] px-3 outline-none transition-colors text-14 lg:text-16 border-[2px] border-[#af7bff] text-neutral-8 focus:border-blue-6 leading-1-4 ",
	...
	return (
		<div className={className} data-te-input-wrapper-init>
			<div className="relative">
				<label
					htmlFor={id}
					className={`text-14 font-normal text-neutral-1 leading-1-4`}
				>
					{nameLabel} {isRequired && <span className="text-red-1">*</span>}
				</label>
				<div className="relative">
					<input
						className={`${classNameInput} input-primary appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer auto-fill-input ${
					...
					{restParams.type === "password" && visible && (
						<svg
							...
							viewBox="0 0 24 24"
							fill="none"
							className="absolute right-3 top-[16px] h-5 w-5 cursor-pointer md:right-4"
