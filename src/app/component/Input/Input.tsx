  ...
  return (
    <div className={className} data-te-input-wrapper-init>
      <div className="relative">
        <label
          htmlFor={id}
          className={`text-14 lg:text-16 font-normal text-neutral-1 leading-1-4 font-semibold ${classNameLabel}`}
        >
          {nameLabel} {isRequired && <span className="text-red-1">*</span>}
        </label>
        <div className="relative">
          <input
            className={`w-full md:h-12 h-11 rounded-[10px] px-3 outline-none transition-colors text-14 lg:text-16 border-[2px] border-blue-15 text-neutral-1 focus:border-blue-7 leading-1-4 bg-transparent ${classNameInput}  auto-fill-input ${
