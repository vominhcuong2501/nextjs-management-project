  ...
  return (
    <>
      {disabled && customDisabled ? (
        ...
        <button
          className={`${newClassName} bg-gradient-to-r from-green-400 via-cyan-400 to-indigo-400 lg:h-14 h-11 rounded-[50px] text-14 lg:text-16 font-semibold w-full
				leading-1-4 text-neutral-1`}
          disabled={disabled}
          {...restParams}
        >
          {children}
