...
export default function FormEditTask({ dataTaskDetail }: FormEditTaskProps) {
  ...
  useEffect(() => {
    if (dataTaskDetail) {
      ...
      // setValue('taskName', dataTaskDetail?.taskName)
      // setValue('description', dataTaskDetail?.description)
      // setValue('taskName', dataTaskDetail?.taskName)
      // setValue('taskName', dataTaskDetail?.taskName)
      // setValue('taskName', dataTaskDetail?.taskName)
      // setValue('taskName', dataTaskDetail?.taskName)
          ...
          <div className='flex items-end md:col-span-2 pr-[40px]'>
            ...
            <p title='Edit Name' onClick={() => setVisibleTaskName(true)}>
              <svg
                ...
                viewBox='0 0 24 24'
                fill='none'
                className='p-1 cursor-pointer mb-1'
              >
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
                    ...
                    {visibleComment && item?.id == commentId ? (
                      <div className='relative flex-1'>
                        <Input
                          ...
                          classNameInput='!bg-neutral-1 text-neutral-8 pl-4'
                          onChange={(e) => setEditCommentUser(e.target.value)}
                        />
                        <button
