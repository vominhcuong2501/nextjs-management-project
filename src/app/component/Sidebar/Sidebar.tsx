...
export default function Sidebar() {
  ...
  const items = [
    getItem(
      <p className="text-neutral-8  font-semibold">
        {isClient && (
    ...
    getItem(
      <p className="text-neutral-8  font-semibold" onClick={handleLogOut}>
        Sign Out
      </p>,
      "6",
      <div className="bg-background-10  shadow-black6 text-center p-2 rounded-xl">
  ...
  return (
    <Sider className="p-2 min-w-100px rounded-lg bg-gradient-to-b from-[#7fe2f3] to-[#5f88c9] bg-opacity-50 ">
      <>
        <Link
          href={PATH_NAME.HOME}
          target="_self"
